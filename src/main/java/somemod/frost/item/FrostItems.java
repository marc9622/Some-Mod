...
public class FrostItems {
    ...
    public static final Item ARCTIC_HAT    = defaultArmorItem("arctic_hat",    ARCTIC, EquipmentSlot.HEAD).addGroupAfter(ItemGroups.COMBAT, Items.LEATHER_BOOTS).build();
    ...
    public static final Item GLACIER_HELMET     = defaultArmorItem("glacier_helmet",     GLACIER, EquipmentSlot.HEAD).addGroupAfter(ItemGroups.COMBAT, Items.CHAINMAIL_BOOTS).build();
    ...
    public static final Item BLIZZARD_BOOTS = defaultArmorItem("blizzard_boots", BLIZZARD, EquipmentSlot.FEET).addGroupAfter(ItemGroups.COMBAT, GLACIER_BOOTS).build();

    public static final Item FROSTBITE_CHESTPLATE = defaultArmorItem("frostbite_chestplate", FROSTBITE, EquipmentSlot.CHEST).addGroupAfter(ItemGroups.COMBAT, Items.IRON_BOOTS).build();
    ...
    public static final Item ICE_QUEEN_CROWN = defaultArmorItem("ice_queen_crown", ICE_QUEEN, EquipmentSlot.HEAD).addGroupAfter(ItemGroups.COMBAT, Items.DIAMOND_BOOTS).build();
