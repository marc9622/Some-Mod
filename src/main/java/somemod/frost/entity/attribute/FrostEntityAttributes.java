...
public final class FrostEntityAttributes {
    ...
    public static final EntityAttribute WARMTH = SomeMod.registerEntityAttribute("warmth", new ClampedEntityAttribute("attribute.name.warmth", 0.0f, -1024.0f, 1024.0f).setTracked(true));
