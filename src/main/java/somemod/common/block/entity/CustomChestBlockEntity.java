package somemod.common.block.entity;
...
public abstract class CustomChestBlockEntity extends ChestBlockEntity {
    ...
    protected static final SpriteIdentifier getTranslucentChestTextureId(String path) {
        SpriteIdentifier spriteId = getChestTextureId(path);
        spriteId.getRenderLayer(id -> RenderLayer.getEntityTranslucent(id));
        return spriteId;
    }
