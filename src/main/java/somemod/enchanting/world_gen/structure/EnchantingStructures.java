...
public class EnchantingStructures {
    ...
    public static void bootstrap(Registerable<Structure> registerable) {
        ...
        SomeMod.register(registerable, ENCHANTING_TOWER_COMMON, ENCHANTING_TOWER_STRUCTURE.apply(EnchantingHasStructureBiomeTags.ENCHANTING_TOWER_COMMON_HAS_STRUCTURE));
        SomeMod.register(registerable, ENCHANTING_TOWER_RARE, ENCHANTING_TOWER_STRUCTURE.apply(EnchantingHasStructureBiomeTags.ENCHANTING_TOWER_RARE_HAS_STRUCTURE));
