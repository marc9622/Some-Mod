package somemod.magic.world_gen.structure.pool;
...
public class MagicStructurePools {
    ...
    public static void bootstrap(Registerable<StructurePool> registerable) {
        ...
        RegistryEntry.Reference<StructureProcessorList> processorList = registerable.getRegistryLookup(RegistryKeys.PROCESSOR_LIST).getOrThrow(MagicStructureProcessorLists.ENCHANTING_TOWER);
