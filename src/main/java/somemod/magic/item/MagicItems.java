...
public class MagicItems {
    ...
    public static final ArmorItem HONEY_BOOTS      = item("honey_boots", RandomEffectArmorItem.of(HONEY, Type.BOOTS).requires(HONEY_MASK, HONEY_CHESTPIECE, HONEY_LEGPIECE)
                                                        .addGroup(StatusEffects.SATURATION).durationAndChance(1, 1f / 600f).build())
                                                                                                          .after(ItemGroups.COMBAT, HONEY_LEGPIECE).build();
    ...
    public static final ArmorItem ALCHEMIST_BOOTS  = item("alchemist_boots", RandomEffectArmorItem.of(ALCHEMIST, Type.BOOTS).requires(ALCHEMIST_JACKET, ALCHEMIST_PANTS)
                                                        ...
                                                        .addGroup(StatusEffects.NAUSEA).and(StatusEffects.POISON).durationAndChance(200, 1f / (20_000f)).build())
                                                                                                              .after(ItemGroups.COMBAT, ALCHEMIST_PANTS).build();
    ...
    public static final ArmorItem NECROTIC_BOOTS      = item("necrotic_boots", StaticEffectArmorItem.of(NECROTIC, Type.BOOTS)
                                                    .requires(NECROTIC_MASK, NECROTIC_CHESTPLATE, NECROTIC_LEGGINGS).gives(StatusEffects.STRENGTH, 1).build())                                                   .after(ItemGroups.COMBAT, NECROTIC_LEGGINGS).build();
    ...
    public static final ArmorItem LIVING_BOOTS    = item("living_boots", RandomEffectArmorItem.of(LIVING, Type.BOOTS).requires(LIVING_MASK, LIVING_SUIT, LIVING_LEGGINGS)
                                                        .addGroup(StatusEffects.REGENERATION).durationAndChance(200, 1f / 100f).build())
                                                                                                         .after(ItemGroups.COMBAT, LIVING_LEGGINGS).build();
    ...
    public static final ArmorItem DEEP_SEA_BOOTS      = item("deep_sea_boots", StaticEffectArmorItem.of(DEEP_SEA, Type.BOOTS)
                                                    .requires(DEEP_SEA_MASK, DEEP_SEA_CHESTPLATE, DEEP_SEA_LEGGINGS).gives(StatusEffects.CONDUIT_POWER).build())                                                   .after(ItemGroups.COMBAT, DEEP_SEA_LEGGINGS).build();
    ...
    public static final ArmorItem GUARDIAN_BOOTS      = item("guardian_boots", StaticEffectArmorItem.of(GUARDIAN, Type.BOOTS)
