...
public class MagicItems {
    ...
    public static final ArmorItem ARCANE_PANTS = defaultArmorItem("arcane_pants", ARCANE, Type.LEGGINGS).groupAfter(ItemGroups.COMBAT, ARCANE_ROBE).build();
    ...
    public static final ArmorItem HONEY_BOOTS      = defaultArmorItem("honey_boots",      HONEY, Type.BOOTS).groupAfter(ItemGroups.COMBAT, HONEY_LEGPIECE).build();
    ...
    public static final ArmorItem ELVEN_BOOTS      = defaultArmorItem("elven_boots",      ELVEN, Type.BOOTS).groupAfter(ItemGroups.COMBAT, ELVEN_LEGGINGS).build();
    ...
    public static final ArmorItem OCEANIC_MASK     = defaultArmorItem("oceanic_mask",     OCEANIC, Type.HELMET).groupAfter(ItemGroups.COMBAT, Items.CHAINMAIL_BOOTS).build();
    ...
    public static final ArmorItem DESERT_BOOTS      = defaultArmorItem("desert_boots",      DESERT, Type.BOOTS).groupAfter(ItemGroups.COMBAT, DESERT_LEGGINGS).build();
    ...
    public static final ArmorItem LUNAR_BOOTS      = defaultArmorItem("lunar_boots",      LUNAR, Type.BOOTS).groupAfter(ItemGroups.COMBAT, LUNAR_LEGGINGS).build();
    ...
    public static final ArmorItem PHANTOM_LEGGINGS   = defaultArmorItem("phantom_leggings",   PHANTOM, Type.LEGGINGS).groupAfter(ItemGroups.COMBAT, PHANTOM_CHESTPLATE).build();
    ...
    public static final ArmorItem DIVINE_BOOTS      = defaultArmorItem("divine_boots",      DIVINE, Type.BOOTS).groupAfter(ItemGroups.COMBAT, DIVINE_LEGGINGS).build();
    ...
    public static final ArmorItem NECROTIC_BOOTS      = defaultArmorItem("necrotic_boots",      NECROTIC, Type.BOOTS).groupAfter(ItemGroups.COMBAT, NECROTIC_LEGGINGS).build();
    ...
    public static final ArmorItem LIVING_BOOTS    = defaultArmorItem("living_boots",    LIVING, Type.BOOTS).groupAfter(ItemGroups.COMBAT, LIVING_LEGGINGS).build();
    ...
    public static final ArmorItem SHADOW_LEGPIECE   = defaultArmorItem("shadow_legpiece",   SHADOW, Type.LEGGINGS).groupAfter(ItemGroups.COMBAT, SHADOW_CHESTPIECE).build();
    ...
    public static final ArmorItem ANGELIC_LEGGINGS   = defaultArmorItem("angelic_leggings",   ANGELIC, Type.LEGGINGS).groupAfter(ItemGroups.COMBAT, ANGELIC_CHESTPLATE).build();
    ...
    public static final ArmorItem DEEP_SEA_BOOTS      = defaultArmorItem("deep_sea_boots",      DEEP_SEA, Type.BOOTS).groupAfter(ItemGroups.COMBAT, DEEP_SEA_LEGGINGS).build();
    ...
    public static final ArmorItem MAGMA_BOOTS      = defaultArmorItem("magma_boots",      MAGMA, Type.BOOTS).groupAfter(ItemGroups.COMBAT, MAGMA_LEGGINGS).build();
    ...
    public static final ArmorItem GUARDIAN_BOOTS      = defaultArmorItem("guardian_boots",      GUARDIAN, Type.BOOTS).groupAfter(ItemGroups.COMBAT, GUARDIAN_LEGGINGS).build();
    //#endregion
