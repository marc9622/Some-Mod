...
public class MagicBlocks {
    ...
    public static final EnchantedBookshelfBlock ENCHANTED_BOOKSHELF =
        newBlock("enchanted_bookshelf", EnchantedBookshelfBlock::new)
    ...
    public static final ObsidianEnchantedBookshelfBlock OBSIDIAN_ENCHANTED_BOOKSHELF =
        newBlock("obsidian_enchanted_bookshelf", ObsidianEnchantedBookshelfBlock::new)
    ...
    public static final CustomChestBlock FORGOTTEN_CHEST =
        newBlock("forgotten_chest", s -> new CustomChestBlock(s, () -> MagicBlockEntityTypes.FORGOTTEN_CHEST_ENTITY))
